...
jit_avx512_core_s16_copy_at_kern::jit_avx512_core_s16_copy_at_kern() :
    ...
    std::cerr << "./inference-engine/thirdparty/mkl-dnn/src/cpu/gemm/bf16/jit_avx512_core_s16_copy_at_kern.cpp:      jit_generator(nullptr, S16_COPY_KERNEL_CODE_SIZE) {" << std::endl;
