...
#ifdef HAVE_AVX512F
REG_FACTORY_FOR_TYPE(avx512_common, ImplFactory<ResampleImpl<mkldnn::impl::cpu::cpu_isa_t::avx512_common>>, Resample);
#elif defined HAVE_AVX2
REG_FACTORY_FOR_TYPE(avx2, ImplFactory<ResampleImpl<mkldnn::impl::cpu::cpu_isa_t::avx2>>, Resample);
#elif defined HAVE_SSE
REG_FACTORY_FOR_TYPE(sse42, ImplFactory<ResampleImpl<mkldnn::impl::cpu::cpu_isa_t::sse42>>, Resample);
#else
REG_FACTORY_FOR_TYPE(isa_any, ImplFactory<ResampleImpl<mkldnn::impl::cpu::cpu_isa_t::isa_any>>, Resample);
#endif
