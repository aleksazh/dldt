...
#ifdef HAVE_AVX512F
REG_FACTORY_FOR_TYPE(avx512_common, ImplFactory<ArgMaxImpl<mkldnn::impl::cpu::cpu_isa_t::avx512_common>>, ArgMax);
#elif defined HAVE_AVX2
REG_FACTORY_FOR_TYPE(avx2, ImplFactory<ArgMaxImpl<mkldnn::impl::cpu::cpu_isa_t::avx2>>, ArgMax);
#elif defined HAVE_SSE
REG_FACTORY_FOR_TYPE(sse42, ImplFactory<ArgMaxImpl<mkldnn::impl::cpu::cpu_isa_t::sse42>>, ArgMax);
#else
REG_FACTORY_FOR_TYPE(isa_any, ImplFactory<ArgMaxImpl<mkldnn::impl::cpu::cpu_isa_t::isa_any>>, ArgMax);
#endif
