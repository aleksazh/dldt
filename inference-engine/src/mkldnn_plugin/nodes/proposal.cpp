...
#ifdef HAVE_AVX512F
REG_FACTORY_FOR_TYPE(avx512_common, ImplFactory<ProposalImpl<mkldnn::impl::cpu::cpu_isa_t::avx512_common>>, Proposal);
#elif defined HAVE_AVX2
REG_FACTORY_FOR_TYPE(avx2, ImplFactory<ProposalImpl<mkldnn::impl::cpu::cpu_isa_t::avx2>>, Proposal);
#elif defined HAVE_SSE
REG_FACTORY_FOR_TYPE(sse42, ImplFactory<ProposalImpl<mkldnn::impl::cpu::cpu_isa_t::sse42>>, Proposal);
#else
REG_FACTORY_FOR_TYPE(isa_any, ImplFactory<ProposalImpl<mkldnn::impl::cpu::cpu_isa_t::isa_any>>, Proposal);
#endif
